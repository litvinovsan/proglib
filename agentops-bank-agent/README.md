...
Полный журнал — [`Roadmap.md`](Roadmap.md), 114 записей с отвергнутыми
...
| [`Roadmap.md`](Roadmap.md) | требования, архитектура, журнал из 114 решений с отвергнутыми альтернативами |
